...
public class MobilityWrapper {
	...
	public static void fillPointsFromFile(STStore[] trees, String[] args) throws Exception {
		...
		Init.CoverageWindow.REFERENCE_TIMESTAMP = timestamp; //should be 0.00 for mobility data
		Init.CoverageWindow.CURRENT_TIMESTAMP = timestamp; //continually update current to simulate real-time insertion of points
